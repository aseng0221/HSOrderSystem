...
const CartScreen = ({navigation}: any) => {
  ...
  const handleCheckout = async () => {
    ...
    /* 
    // ---- Fiuu Implementation (WIP) ----
    const paymentDetails = {
      // TODO: Replace with actual Fiuu credentials
      mp_username: 'thensonpudding@domain.com', // replace with Fiuu username
      mp_password: 'uLVuwo3j', // replace with Fiuu password
      mp_merchant_ID: 'thensonpudding_Dev', // replace with Fiuu Merchant ID
      mp_app_name: 'appname', // replace with Fiuu app name
      mp_verification_key: '838fdb5f1cdf922fd7c6f8ca631b4bef', // replace with Fiuu verification key
